"""Promueve la escena Jigglypuff Corazon de QA oculto a producción."""
...
SID = "jigglypuff_corazon_parallax"
...
def main():
    ...
    if len(spec.get("image_layers", [])) != 8 or len(spec.get("cycles", [])) != 2:
        raise RuntimeError("Spec inesperado: se cancela promoción")
    spec["published"] = True
