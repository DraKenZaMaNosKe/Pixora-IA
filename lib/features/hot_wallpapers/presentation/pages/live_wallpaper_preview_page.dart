...
class _LiveWallpaperPreviewPageState extends State<LiveWallpaperPreviewPage> {
  ...
  /// Apple Music "Now Playing" inspired layout — DEPRECATED 2026-05-16 in
  /// favor of `_buildAppleProScaffold` (App Store pattern, Eduardo pick).
  /// Kept temporarily as fallback while the new design is validated; can be
  /// removed in a follow-up cleanup commit once 1.7.18 ships.
