...
class _DayCycleDetailPageState extends ConsumerState<DayCycleDetailPage> {
  ...
  Future<void> _activate() async {
    ...
    final success = await DayCycleService.instance.activate(
      ...
      onProgress: (current, total) {
        if (mounted) {
          setState(() => _progressText = 'Downloading image $current/$total...');
        }
      },
    );
    ...
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${widget.theme.name} day cycle activated!'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Failed to activate. Check your connection.'),
  ...
  Future<void> _deactivate() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Day cycle deactivated')),
      );
    }
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isActivating
                          ...
                          : Text(
                              isActive ? 'Deactivate Day Cycle' : 'Activate Day Cycle',
        ...
        child: SizedBox(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                width: 130,
                child: Image.network(imageUrl, fit: BoxFit.cover, height: 90,
