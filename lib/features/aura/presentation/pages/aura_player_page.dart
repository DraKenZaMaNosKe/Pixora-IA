...
class _AuraPlayerPageState extends State<AuraPlayerPage> {
  ...
  void initState() {
    super.initState();
    // Track that the user opened this AURA track (counts as a view).
    WallpaperStatsService.instance.trackView('aura_${widget.track.id}');
  }
              ...
              children: [
                ...
                StreamBuilder<Duration>(
                  ...
                  builder: (_, snap) {
                    ...
                    final dur =
                        svc.duration ?? Duration(seconds: t.durationSec);
                    return Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 24),
                      child: Column(
                        children: [
