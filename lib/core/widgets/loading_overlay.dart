...
class _LoadingOverlayState extends State<LoadingOverlay>
  ...
  Widget build(BuildContext context) {
    ...
    final accent = isError ? HudTokens.goldDeep : widget.accentColor;
  ...
  Widget _buildIndicator(bool isDone, bool isError, Color accent) {
    ...
    if (isDone) {
      ...
      return ScaleTransition(
        ...
        child: Icon(Icons.check_circle_rounded, color: context.hud.accent,
    ...
    if (isError) {
      ...
      return Icon(Icons.error_outline_rounded, color: HudTokens.goldDeep,
